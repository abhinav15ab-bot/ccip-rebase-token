...
// * @dev Rebase token
// * @author Abhinav Malik
// * @notice The interest rate in SC can only decrease and rebase token
// * @notice Each will user will hace their own interest rate that is global interest rate at the time of depositing 
// */
...
//     bytes32 private constant MINT_AND_BURN_ROLE = keccak("MINT_AND_BURN_ROLE");
