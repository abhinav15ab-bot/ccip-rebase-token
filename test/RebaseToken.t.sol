...
//         uint256 middleBalance = rebaseToken.balanceOf(user);
//         assertGt(middleBalance, startBalance);
//         //4. warp the time again by the same amout and check the balamce
//         vm.warp(block.timestamp + 1 hours);
//         uint256 endBalance = rebaseToken.balanceOf(user);
//         assertGt(endBalance, endBalance);  
//         assertApproxEqAbs(endBalance - middleBalance, middleBalance - startBalance);
